...
<section>
	...
	<tr>
		<td colspan="3"><h2>[RE]: 제목1</h2>	
	 	...
	 	<td colspan="1"><small>조회수:12</small></td>
	 </tr>
	...
	<tr>
	 ...
	 <tr onclick="location.href='comment_content.do'" style="cursor:pointer;">
	 ...
	 <div>
	 <button type="button" onclick="location.href='comment_update.do'">수정</button>
	 <button type="button" onclick="alert('삭제기능 구현 예정')">삭제</button>
	 
	 <button type="button" onclick="location.href='comment_list.do'">목록</button>
	 </div>
