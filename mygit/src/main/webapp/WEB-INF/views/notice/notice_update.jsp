...
<form name="faq_write" action="#" method="post" enctype="multipart/form-data">
		...
		<hr>
	 	...
	 	<!-- 버튼 -->
	 	<button type="button" onclick="location.href='notice_content.do'" class="btn_normal">취소</button>
	 	<button type="button" onclick="location.href='notice_list.do'" class="btn_normal">수정</button>
	 </form>
</section>
