...
<section>
	...
	<tr>
	 ...
	 <tr onclick="location.href='notice_content.do'"  class="pageMove">
	 	 		...
	 	 		<td colspan="4"><b>제목2</b></td>
	 </tr>
	 <tr><td colspan="4"><hr></td></tr>
	 <tr onclick="location.href='notice_content.do'"  class="pageMove">
	 	 		<td>다음글</td>
	 	 		<td colspan="4"><b>제목3</b></td>
	</tr>
	<tr><td colspan="4"><hr></td></tr>
	 </table>	 		

	 <div>
	 <button type="button" onclick="location.href='notice_update.do'" class="btn_normal" style="float:left;">수정</button>
	 <button type="button" onclick="alert('삭제기능 구현 예정')" class="btn_normal" style="float:left;">삭제</button>
	 
	 <button type="button" onclick="location.href='notice_list.do'" class="btn_normal">목록</button>
	 </div>
