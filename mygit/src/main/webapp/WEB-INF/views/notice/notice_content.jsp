...
<section>
	...
	<tr>
	 ...
	 <tr onclick="location.href='notice_content.do'" style="cursor:pointer;">
	 ...
	 <div>
	 <button type="button" onclick="location.href='notice_update.do'">수정</button>
	 <button type="button" onclick="alert('삭제기능 구현 예정')">삭제</button>
	 
	 <button type="button" onclick="location.href='notice_list.do'">목록</button>
	 </div>
